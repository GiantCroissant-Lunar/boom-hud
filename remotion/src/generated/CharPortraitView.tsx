...
export function CharPortraitView(props: CharPortraitViewModel): React.JSX.Element {
  return (
    <div className='boomhud-node boomhud-component-charportrait' style={ { display: 'flex', flexDirection: 'column', gap: '8px', padding: '0', margin: '0', width: '130px', alignItems: 'center', justifyContent: 'flex-start', color: '#000000', backgroundColor: '#000000', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Component/CharPortrait')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Component/CharPortrait')}>
      <div className='boomhud-node boomhud-face' style={ { padding: '0', margin: '0', width: '56px', height: '56px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#000000', backgroundColor: '#000000', fontWeight: '400', borderStyle: 'solid', borderWidth: '6px', borderColor: '#FFFFFF', position: 'absolute', left: '0px', top: '0px', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'face')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'face')}>
        <span className='boomhud-node boomhud-classicon' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '32px', height: '32px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontFamily: 'lucide', fontWeight: '400', position: 'absolute', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'classIcon')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'classIcon')}>
          {resolveIconText(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'classIcon')) ?? ('shield'), 'lucide')}
        </span>
      </div>
      <span className='boomhud-node boomhud-name' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontSize: '8px', fontFamily: 'Press Start 2P', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'name')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'name')}>
        {getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'name')) ?? ('Name')}
      </span>
      <div className='boomhud-node boomhud-hp' style={ { padding: '0', margin: '0', alignSelf: 'stretch', height: '10px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#333333', backgroundColor: '#333333', fontWeight: '400', position: 'absolute', left: '0px', top: '0px', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'hp')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'hp')}>
        <section className='boomhud-node boomhud-hpfill' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '90px', height: '10px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#CCCCCC', backgroundColor: '#CCCCCC', fontWeight: '400', position: 'absolute', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'hpFill')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'hpFill')} />
      </div>
      <div className='boomhud-node boomhud-mp' style={ { padding: '0', margin: '0', alignSelf: 'stretch', height: '8px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#333333', backgroundColor: '#333333', fontWeight: '400', position: 'absolute', left: '0px', top: '0px', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'mp')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'mp')}>
        <section className='boomhud-node boomhud-mpfill' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '60px', height: '8px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#777777', backgroundColor: '#777777', fontWeight: '400', position: 'absolute', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'mpFill')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'mpFill')} />
      </div>
      <div className='boomhud-node boomhud-stats' style={ { display: 'flex', flexDirection: 'row', gap: '8px', padding: '0 6px', margin: '0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'center', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'stats')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'stats')}>
        <span className='boomhud-node boomhud-stat1' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#AAAAAA', fontSize: '8px', fontFamily: 'Press Start 2P', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'stat1')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'stat1')}>
          {getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'stat1')) ?? ('ATK 10')}
        </span>
        <span className='boomhud-node boomhud-stat2' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#AAAAAA', fontSize: '8px', fontFamily: 'Press Start 2P', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'stat2')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'stat2')}>
          {getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'stat2')) ?? ('DEF 8')}
        </span>
      </div>
      <div className='boomhud-node boomhud-actiongrid' style={ { display: 'flex', flexDirection: 'row', gap: '2px', padding: '0', margin: '0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'actionGrid')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'actionGrid')}>
        <div className='boomhud-node boomhud-atk' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', fontWeight: '400', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'atk')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'atk')}>
          <span className='boomhud-node boomhud-qepo3' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontFamily: 'lucide', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'qEpO3')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'qEpO3')}>
            {resolveIconText(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'qEpO3')) ?? ('swords'), 'lucide')}
          </span>
        </div>
        <div className='boomhud-node boomhud-mag' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', fontWeight: '400', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'mag')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'mag')}>
          <span className='boomhud-node boomhud-aiphn' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontFamily: 'lucide', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'AIphN')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'AIphN')}>
            {resolveIconText(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'AIphN')) ?? ('wand-sparkles'), 'lucide')}
          </span>
        </div>
        <div className='boomhud-node boomhud-def' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', fontWeight: '400', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'def')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'def')}>
          <span className='boomhud-node boomhud-e4qkz' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontFamily: 'lucide', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'e4QKZ')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'e4QKZ')}>
            {resolveIconText(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'e4QKZ')) ?? ('shield'), 'lucide')}
          </span>
        </div>
        <div className='boomhud-node boomhud-item' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', fontWeight: '400', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'item')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'item')}>
          <span className='boomhud-node boomhud-dvzx7' style={ { display: 'flex', flexDirection: 'column', padding: '0', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontFamily: 'lucide', fontWeight: '400', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'dVzX7')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'dVzX7')}>
            {resolveIconText(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'dVzX7')) ?? ('flask-conical'), 'lucide')}
          </span>
        </div>
      </div>
    </div>
