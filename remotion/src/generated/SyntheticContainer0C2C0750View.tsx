...
export interface SyntheticContainer0C2C0750ViewModel {
...
export function SyntheticContainer0C2C0750View(props: SyntheticContainer0C2C0750ViewModel): React.JSX.Element {
  return (
    <div className='boomhud-node boomhud-char-1-actiongrid' style={ { padding: '0', display: 'flex', flexDirection: 'row', gap: '2px', margin: '0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid')}>
      <div className='boomhud-node boomhud-char-1-actiongrid-atk' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/atk')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/atk')}>
        <span className='boomhud-node boomhud-char-1-actiongrid-atk-qepo3' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontSize: '16px', fontFamily: 'lucide', whiteSpace: 'nowrap', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/atk/qEpO3')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/atk/qEpO3')}>
          {renderIconContent(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/atk/qEpO3')) ?? ('swords'), 'lucide')}
        </span>
      </div>
      <div className='boomhud-node boomhud-char-1-actiongrid-mag' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/mag')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/mag')}>
        <span className='boomhud-node boomhud-char-1-actiongrid-mag-aiphn' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontSize: '16px', fontFamily: 'lucide', whiteSpace: 'nowrap', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/mag/AIphN')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/mag/AIphN')}>
          {renderIconContent(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/mag/AIphN')) ?? ('wand-sparkles'), 'lucide')}
        </span>
      </div>
      <div className='boomhud-node boomhud-char-1-actiongrid-def' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/def')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/def')}>
        <span className='boomhud-node boomhud-char-1-actiongrid-def-e4qkz' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontSize: '16px', fontFamily: 'lucide', whiteSpace: 'nowrap', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/def/e4QKZ')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/def/e4QKZ')}>
          {renderIconContent(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/def/e4QKZ')) ?? ('shield'), 'lucide')}
        </span>
      </div>
      <div className='boomhud-node boomhud-char-1-actiongrid-item' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', height: '28px', alignItems: 'center', justifyContent: 'center', color: '#000000', backgroundColor: '#000000', borderStyle: 'solid', borderWidth: '2px', borderColor: '#FFFFFF', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/item')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/item')}>
        <span className='boomhud-node boomhud-char-1-actiongrid-item-dvzx7' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', width: '16px', height: '16px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#FFFFFF', fontSize: '16px', fontFamily: 'lucide', whiteSpace: 'nowrap', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/item/dVzX7')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Char 1/actionGrid/item/dVzX7')}>
          {renderIconContent(getMotionText(props.motionTargets, resolveMotionId(props.motionScope, 'Char 1/actionGrid/item/dVzX7')) ?? ('flask-conical'), 'lucide')}
        </span>
      </div>
    </div>
  );
}
export default SyntheticContainer0C2C0750View;
