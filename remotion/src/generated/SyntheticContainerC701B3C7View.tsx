...
export interface SyntheticContainerC701B3C7ViewModel {
...
export function SyntheticContainerC701B3C7View(props: SyntheticContainerC701B3C7ViewModel): React.JSX.Element {
  return (
    <div className='boomhud-node boomhud-r8' style={ { padding: '0', display: 'flex', flexDirection: 'row', gap: '2px', margin: '0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'r8')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'r8')}>
      <section className='boomhud-node boomhud-8-0' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-0')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-0')} />
      <section className='boomhud-node boomhud-8-1' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-1')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-1')} />
      <section className='boomhud-node boomhud-8-2' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-2')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-2')} />
      <section className='boomhud-node boomhud-8-3' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-3')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-3')} />
      <section className='boomhud-node boomhud-8-4' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-4')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-4')} />
      <section className='boomhud-node boomhud-8-5' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-5')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-5')} />
      <section className='boomhud-node boomhud-8-6' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-6')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-6')} />
      <section className='boomhud-node boomhud-8-7' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-7')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-7')} />
      <section className='boomhud-node boomhud-8-8' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-8')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-8')} />
      <section className='boomhud-node boomhud-8-9' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', flex: '1 1 0', alignSelf: 'stretch', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#0A0A0A', backgroundColor: '#0A0A0A', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, '8-9')) } } data-boomhud-id={resolveMotionId(props.motionScope, '8-9')} />
    </div>
  );
}
export default SyntheticContainerC701B3C7View;
