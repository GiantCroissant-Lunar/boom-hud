...
export function StatBarView(props: StatBarViewModel): React.JSX.Element {
  return (
    <div className='boomhud-node boomhud-component-statbar' style={ { padding: '0', margin: '0', width: '108px', height: '12px', position: 'relative', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#333333', backgroundColor: '#333333', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'Component/StatBar')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'Component/StatBar')}>
      <section className='boomhud-node boomhud-fill' style={ { padding: '0', display: 'flex', flexDirection: 'column', margin: '0', width: '80px', height: '12px', alignItems: 'flex-start', justifyContent: 'flex-start', color: '#CCCCCC', backgroundColor: '#CCCCCC', position: 'absolute', left: '0px', top: '0px', ...getMotionStyle(props.motionTargets, resolveMotionId(props.motionScope, 'fill')) } } data-boomhud-id={resolveMotionId(props.motionScope, 'fill')} />
    </div>
  );
}
