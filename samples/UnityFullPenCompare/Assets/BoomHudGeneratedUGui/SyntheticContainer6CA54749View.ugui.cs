...
public sealed class SyntheticContainer6CA54749View
{
    ...
    public TextMeshProUGUI RecipeCard02Title { get; }
    public TextMeshProUGUI RecipeCard02Body { get; }
    ...
    public SyntheticContainer6CA54749View(Transform? parent = null, ISyntheticContainer6CA54749ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer6CA54749Root", parent);
        ConfigureRect(Root, width: null, height: 110f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: null, preferredHeight: 110f, flexibleWidth: 1f, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 8f, 12, 12, 12, 12, "top-left");
        ApplyStyle(Root, fg: "#2A2D34", bg: "#2A2D34", fontFamily: null, fontSize: null, borderColor: "#746245", borderWidth: 2f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        RecipeCard02Title = CreateText("RecipeCard02Title", Root);
        ConfigureRect(RectOf(RecipeCard02Title), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(RecipeCard02Title), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(RecipeCard02Title), horizontal: false, vertical: false);
        ApplyStyle(RecipeCard02Title, fg: "#F0E5D2", bg: null, fontFamily: "Press Start 2P", fontSize: 10, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(RecipeCard02Title, lineSpacing: null, letterSpacing: null, wrapText: false);
        RecipeCard02Title.text = "GREENHOUSE POD";
        RecipeCard02Title.gameObject.SetActive(true);
        RecipeCard02Body = CreateText("RecipeCard02Body", Root);
        ConfigureRect(RectOf(RecipeCard02Body), width: 420f, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(RecipeCard02Body), ignoreLayout: false, preferredWidth: 420f, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(RecipeCard02Body), horizontal: false, vertical: false);
        ApplyStyle(RecipeCard02Body, fg: "#C0C5CE", bg: null, fontFamily: "Press Start 2P", fontSize: 8, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(RecipeCard02Body, lineSpacing: null, letterSpacing: null, wrapText: true);
        RecipeCard02Body.text = "PROVIDES FRESH FOOD AND A SMALL MORALE BONUS FOR THE WHOLE BASE.";
        RecipeCard02Body.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer6CA54749View(RectTransform root, ISyntheticContainer6CA54749ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        RecipeCard02Title = RequireComponent<TextMeshProUGUI>(Root, "RecipeCard02Title");
        RecipeCard02Body = RequireComponent<TextMeshProUGUI>(Root, "RecipeCard02Body");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer6CA54749View Bind(RectTransform root, ISyntheticContainer6CA54749ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
