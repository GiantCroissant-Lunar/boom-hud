...
public sealed class SyntheticContainer61D6E26DView
{
    ...
    public TextMeshProUGUI EventIcon { get; }
    ...
    public SyntheticContainer61D6E26DView(Transform? parent = null, ISyntheticContainer61D6E26DViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer61D6E26DRoot", parent);
        ConfigureRect(Root, width: 132f, height: 132f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 132f, preferredHeight: 132f, flexibleWidth: null, flexibleHeight: null);
        ...
        ApplyStyle(Root, fg: "#000000", bg: "#000000", fontFamily: null, fontSize: null, borderColor: "#EAEAEA", borderWidth: 4f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        EventIcon = CreateText("EventIcon", Root);
        ...
        ApplyIconMetrics(EventIcon, boxWidth: 56f, boxHeight: 56f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 56f);
    ...
    private SyntheticContainer61D6E26DView(RectTransform root, ISyntheticContainer61D6E26DViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        EventIcon = RequireComponent<TextMeshProUGUI>(Root, "EventIcon");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer61D6E26DView Bind(RectTransform root, ISyntheticContainer61D6E26DViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            EventIcon.text = ResolveIconText(AsString(componentOverrideValue0));
        }
    }
