...
public sealed class SyntheticContainer62FD2935View
{
    ...
    public TextMeshProUGUI ListQuestTwoTitle { get; }
    public TextMeshProUGUI ListQuestTwoDistance { get; }
    ...
    public SyntheticContainer62FD2935View(Transform? parent = null, ISyntheticContainer62FD2935ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer62FD2935Root", parent);
        ConfigureRect(Root, width: null, height: 96f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: null, preferredHeight: 96f, flexibleWidth: 1f, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 10f, 16, 16, 16, 16, "top-left");
        ApplyStyle(Root, fg: "#5A6573D8", bg: "#5A6573D8", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        ListQuestTwoTitle = CreateText("ListQuestTwoTitle", Root);
        ConfigureRect(RectOf(ListQuestTwoTitle), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(ListQuestTwoTitle), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(ListQuestTwoTitle), horizontal: false, vertical: false);
        ApplyStyle(ListQuestTwoTitle, fg: "#F0EBE2", bg: null, fontFamily: "Press Start 2P", fontSize: 13, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(ListQuestTwoTitle, lineSpacing: null, wrapText: false);
        ListQuestTwoTitle.text = "CRASH COURSE";
        ListQuestTwoTitle.gameObject.SetActive(true);
        ListQuestTwoDistance = CreateText("ListQuestTwoDistance", Root);
        ConfigureRect(RectOf(ListQuestTwoDistance), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(ListQuestTwoDistance), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(ListQuestTwoDistance), horizontal: false, vertical: false);
        ApplyStyle(ListQuestTwoDistance, fg: "#C4C1B9", bg: null, fontFamily: "Press Start 2P", fontSize: 11, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(ListQuestTwoDistance, lineSpacing: null, wrapText: false);
        ListQuestTwoDistance.text = "212m";
        ListQuestTwoDistance.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer62FD2935View(RectTransform root, ISyntheticContainer62FD2935ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        ListQuestTwoTitle = RequireComponent<TextMeshProUGUI>(Root, "ListQuestTwoTitle");
        ListQuestTwoDistance = RequireComponent<TextMeshProUGUI>(Root, "ListQuestTwoDistance");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer62FD2935View Bind(RectTransform root, ISyntheticContainer62FD2935ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
