...
public sealed class SyntheticContainer0B5C2A08View
{
    ...
    public TextMeshProUGUI WorkerInfoOneName { get; }
    public TextMeshProUGUI WorkerInfoOneMeta { get; }
    ...
    public SyntheticContainer0B5C2A08View(Transform? parent = null, ISyntheticContainer0B5C2A08ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer0B5C2A08Root", parent);
        ConfigureRect(Root, width: 320f, height: 56f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 320f, preferredHeight: 56f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 6f, 0, 0, 0, 0, "top-left");
        ApplyStyle(Root, fg: "#24272E", bg: "#24272E", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        WorkerInfoOneName = CreateText("WorkerInfoOneName", Root);
        ConfigureRect(RectOf(WorkerInfoOneName), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(WorkerInfoOneName), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(WorkerInfoOneName), horizontal: false, vertical: false);
        ApplyStyle(WorkerInfoOneName, fg: "#F0E5D2", bg: null, fontFamily: "Press Start 2P", fontSize: 8, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(WorkerInfoOneName, lineSpacing: null, letterSpacing: null, wrapText: false);
        WorkerInfoOneName.text = "TECHNICIAN JAN";
        WorkerInfoOneName.gameObject.SetActive(true);
        WorkerInfoOneMeta = CreateText("WorkerInfoOneMeta", Root);
        ConfigureRect(RectOf(WorkerInfoOneMeta), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(WorkerInfoOneMeta), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(WorkerInfoOneMeta), horizontal: false, vertical: false);
        ApplyStyle(WorkerInfoOneMeta, fg: "#94D5F5", bg: null, fontFamily: "Press Start 2P", fontSize: 8, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(WorkerInfoOneMeta, lineSpacing: null, letterSpacing: null, wrapText: false);
        WorkerInfoOneMeta.text = "EFFICIENCY 112%";
        WorkerInfoOneMeta.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer0B5C2A08View(RectTransform root, ISyntheticContainer0B5C2A08ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        WorkerInfoOneName = RequireComponent<TextMeshProUGUI>(Root, "WorkerInfoOneName");
        WorkerInfoOneMeta = RequireComponent<TextMeshProUGUI>(Root, "WorkerInfoOneMeta");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer0B5C2A08View Bind(RectTransform root, ISyntheticContainer0B5C2A08ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
