...
public sealed class SyntheticContainerAF9ECAF6View
{
    ...
    private SyntheticContainerAF9ECAF6View(RectTransform root, ISyntheticContainerAF9ECAF6ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        ...
        RoleIcon = RequireComponent<Text>(Root, "Portrait/RoleIcon");
        Identity = RequireRect(Root, "Identity");
        MemberName = RequireComponent<Text>(Root, "Identity/MemberName");
        MemberRole = RequireComponent<Text>(Root, "Identity/MemberRole");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }
