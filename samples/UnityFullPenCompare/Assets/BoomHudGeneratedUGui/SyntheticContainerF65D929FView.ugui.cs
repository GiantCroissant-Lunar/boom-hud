...
public sealed class SyntheticContainerF65D929FView
{
    ...
    public TextMeshProUGUI TabThreeText { get; }
    ...
    public SyntheticContainerF65D929FView(Transform? parent = null, ISyntheticContainerF65D929FViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerF65D929FRoot", parent);
        ConfigureRect(Root, width: 86f, height: 86f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 86f, preferredHeight: 86f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 0f, 0, 0, 0, 0, "center");
        ApplyStyle(Root, fg: "#334355", bg: "#334355", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        TabThreeText = CreateText("TabThreeText", Root);
        ConfigureRect(RectOf(TabThreeText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(TabThreeText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(TabThreeText), horizontal: false, vertical: false);
        ApplyStyle(TabThreeText, fg: "#F3E7C8", bg: null, fontFamily: "Press Start 2P", fontSize: 22, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(TabThreeText, lineSpacing: null, wrapText: false);
        TabThreeText.text = "!";
        TabThreeText.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainerF65D929FView(RectTransform root, ISyntheticContainerF65D929FViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        TabThreeText = RequireComponent<TextMeshProUGUI>(Root, "TabThreeText");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerF65D929FView Bind(RectTransform root, ISyntheticContainerF65D929FViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
