...
{
public sealed class SyntheticContainer100280A5View
{
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainer100280A5ViewModel? _viewModel;
    ...
    public ISyntheticContainer100280A5ViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainer100280A5View(Transform? parent = null, ISyntheticContainer100280A5ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer100280A5Root", parent);
        ConfigureRect(Root, width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: 1f, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: true);
        ApplyHorizontalLayout(Root, 2f, 0, 0, 0, 0, "top-left", childControlWidth: true, childControlHeight: false);
        ApplyStyle(Root, fg: null, bg: null, fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        Char1ActionGridAtk = CreateRect("Char1ActionGridAtk", Root);
        ...
        ApplyVerticalLayout(RectOf(Char1ActionGridAtk), 0f, 0, 0, 0, 0, "center", childControlWidth: false, childControlHeight: false);
        ...
        ApplyIconMetrics(Char1ActionGridAtkQEpO3, boxWidth: 16f, boxHeight: 16f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 16f);
        ApplyTextMetrics(Char1ActionGridAtkQEpO3, lineSpacing: null, wrapText: false);
        Char1ActionGridAtkQEpO3.text = ResolveIconText("swords");
        Char1ActionGridAtkQEpO3.gameObject.SetActive(true);
        Char1ActionGridMag = CreateRect("Char1ActionGridMag", Root);
        ...
        ApplyVerticalLayout(RectOf(Char1ActionGridMag), 0f, 0, 0, 0, 0, "center", childControlWidth: false, childControlHeight: false);
        ...
        ApplyIconMetrics(Char1ActionGridMagAIphN, boxWidth: 16f, boxHeight: 16f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 16f);
        ApplyTextMetrics(Char1ActionGridMagAIphN, lineSpacing: null, wrapText: false);
        Char1ActionGridMagAIphN.text = ResolveIconText("wand-sparkles");
        Char1ActionGridMagAIphN.gameObject.SetActive(true);
        Char1ActionGridDef = CreateRect("Char1ActionGridDef", Root);
        ...
        ApplyVerticalLayout(RectOf(Char1ActionGridDef), 0f, 0, 0, 0, 0, "center", childControlWidth: false, childControlHeight: false);
        ...
        ApplyIconMetrics(Char1ActionGridDefE4QKZ, boxWidth: 16f, boxHeight: 16f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 16f);
        ApplyTextMetrics(Char1ActionGridDefE4QKZ, lineSpacing: null, wrapText: false);
        Char1ActionGridDefE4QKZ.text = ResolveIconText("shield");
        Char1ActionGridDefE4QKZ.gameObject.SetActive(true);
        Char1ActionGridItem = CreateRect("Char1ActionGridItem", Root);
        ...
        ApplyVerticalLayout(RectOf(Char1ActionGridItem), 0f, 0, 0, 0, 0, "center", childControlWidth: false, childControlHeight: false);
        ...
        ApplyIconMetrics(Char1ActionGridItemDVzX7, boxWidth: 16f, boxHeight: 16f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 16f);
        ApplyTextMetrics(Char1ActionGridItemDVzX7, lineSpacing: null, wrapText: false);
    ...
    private SyntheticContainer100280A5View(RectTransform root, ISyntheticContainer100280A5ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Char1ActionGridAtk = RequireRect(Root, "Char1ActionGridAtk");
        Char1ActionGridAtkQEpO3 = RequireComponent<Text>(Root, "Char1ActionGridAtk/Char1ActionGridAtkQEpO3");
        Char1ActionGridMag = RequireRect(Root, "Char1ActionGridMag");
        Char1ActionGridMagAIphN = RequireComponent<Text>(Root, "Char1ActionGridMag/Char1ActionGridMagAIphN");
        Char1ActionGridDef = RequireRect(Root, "Char1ActionGridDef");
        Char1ActionGridDefE4QKZ = RequireComponent<Text>(Root, "Char1ActionGridDef/Char1ActionGridDefE4QKZ");
        Char1ActionGridItem = RequireRect(Root, "Char1ActionGridItem");
        Char1ActionGridItemDVzX7 = RequireComponent<Text>(Root, "Char1ActionGridItem/Char1ActionGridItemDVzX7");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer100280A5View Bind(RectTransform root, ISyntheticContainer100280A5ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            Char1ActionGridAtkQEpO3.text = ResolveIconText(AsString(componentOverrideValue0));
        }
        if (TryGetComponentOverrideValue("$/1/0", "Text", out var componentOverrideValue1))
        {
            Char1ActionGridMagAIphN.text = ResolveIconText(AsString(componentOverrideValue1));
        }
        if (TryGetComponentOverrideValue("$/2/0", "Text", out var componentOverrideValue2))
        {
            Char1ActionGridDefE4QKZ.text = ResolveIconText(AsString(componentOverrideValue2));
        }
        if (TryGetComponentOverrideValue("$/3/0", "Text", out var componentOverrideValue3))
        {
            Char1ActionGridItemDVzX7.text = ResolveIconText(AsString(componentOverrideValue3));
        }
    }
