...
public sealed class SyntheticContainerC520AC99View
{
    ...
    public TextMeshProUGUI ObjectiveIcon1 { get; }
    public RectTransform ObjectiveText1 { get; }
    public TextMeshProUGUI ObjectiveTitle1 { get; }
    public TextMeshProUGUI ObjectiveHint1 { get; }
    ...
    public SyntheticContainerC520AC99View(Transform? parent = null, ISyntheticContainerC520AC99ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerC520AC99Root", parent);
        ...
        ApplyIconMetrics(ObjectiveIcon1, boxWidth: 20f, boxHeight: 20f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 20f);
        ...
        ApplyStyle(ObjectiveHint1, fg: "#AAAAAA", bg: null, fontFamily: "Press Start 2P", fontSize: 9, borderColor: null, borderWidth: null, treatAsIcon: false);
    ...
    private SyntheticContainerC520AC99View(RectTransform root, ISyntheticContainerC520AC99ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        IconShell1 = RequireRect(Root, "IconShell1");
        ObjectiveIcon1 = RequireComponent<TextMeshProUGUI>(Root, "IconShell1/ObjectiveIcon1");
        ObjectiveText1 = RequireRect(Root, "ObjectiveText1");
        ObjectiveTitle1 = RequireComponent<TextMeshProUGUI>(Root, "ObjectiveText1/ObjectiveTitle1");
        ObjectiveHint1 = RequireComponent<TextMeshProUGUI>(Root, "ObjectiveText1/ObjectiveHint1");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerC520AC99View Bind(RectTransform root, ISyntheticContainerC520AC99ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            ObjectiveIcon1.text = ResolveIconText(AsString(componentOverrideValue0));
        }
