...
public sealed class SyntheticContainerC520AC99View
{
    ...
    private SyntheticContainerC520AC99View(RectTransform root, ISyntheticContainerC520AC99ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        ...
        ObjectiveIcon1 = RequireComponent<Text>(Root, "IconShell1/ObjectiveIcon1");
        ObjectiveText1 = RequireRect(Root, "ObjectiveText1");
        ObjectiveTitle1 = RequireComponent<Text>(Root, "ObjectiveText1/ObjectiveTitle1");
        ObjectiveHint1 = RequireComponent<Text>(Root, "ObjectiveText1/ObjectiveHint1");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }
