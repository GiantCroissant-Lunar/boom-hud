...
public sealed class SyntheticContainerFA4632C6View
{
    ...
    public SyntheticContainerFA4632C6View(Transform? parent = null, ISyntheticContainerFA4632C6ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerFA4632C6Root", parent);
        ...
        Char3StatsStat1 = CreateText("Char3StatsStat1", Root);
        ...
        ApplyTextMetrics(Char3StatsStat1, lineSpacing: null, wrapText: false);
        Char3StatsStat1.text = "ATK 14";
        Char3StatsStat1.gameObject.SetActive(true);
        Char3StatsStat2 = CreateText("Char3StatsStat2", Root);
        ...
        ApplyTextMetrics(Char3StatsStat2, lineSpacing: null, wrapText: false);
    ...
    private SyntheticContainerFA4632C6View(RectTransform root, ISyntheticContainerFA4632C6ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Char3StatsStat1 = RequireComponent<Text>(Root, "Char3StatsStat1");
        Char3StatsStat2 = RequireComponent<Text>(Root, "Char3StatsStat2");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerFA4632C6View Bind(RectTransform root, ISyntheticContainerFA4632C6ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            Char3StatsStat1.text = AsString(componentOverrideValue0);
        }
        if (TryGetComponentOverrideValue("$/1", "Text", out var componentOverrideValue1))
        {
            Char3StatsStat2.text = AsString(componentOverrideValue1);
        }
    }
