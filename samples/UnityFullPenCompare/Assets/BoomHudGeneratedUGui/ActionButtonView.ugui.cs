...
public sealed class ActionButtonView
{
    ...
    public ActionButtonView(Transform? parent = null, IActionButtonViewModel? viewModel = null)
    {
    ...
    private ActionButtonView(RectTransform root, IActionButtonViewModel? viewModel)
    {
        Root = root;
    ...
    public static ActionButtonView Bind(RectTransform root, IActionButtonViewModel? viewModel = null) => new(root, viewModel);
