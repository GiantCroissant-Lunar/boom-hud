...
public sealed class StatusIconView
{
    ...
    public StatusIconView(Transform? parent = null, IStatusIconViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("StatusIconRoot", parent);
        ConfigureRect(Root, width: 24f, height: 24f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 24f, preferredHeight: 24f, flexibleWidth: null, flexibleHeight: null);
        ...
        ConfigureRect(RectOf(Icon), width: 24f, height: 24f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(Icon), ignoreLayout: false, preferredWidth: 24f, preferredHeight: 24f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Icon), horizontal: false, vertical: false);
        ApplyStyle(Icon, fg: "#FFFFFF", bg: null, fontFamily: "lucide", fontSize: 24, borderColor: null, borderWidth: null, treatAsIcon: true);
        ApplyIconMetrics(Icon, boxWidth: 24f, boxHeight: 24f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 24f);
        ApplyTextMetrics(Icon, lineSpacing: null, wrapText: false);
        Icon.text = ResolveIconText("flame");
        Icon.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private StatusIconView(RectTransform root, IStatusIconViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
    ...
    public static StatusIconView Bind(RectTransform root, IStatusIconViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
