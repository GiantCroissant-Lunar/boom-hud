...
public sealed class StatusIconView
{
    ...
    public StatusIconView(Transform? parent = null, IStatusIconViewModel? viewModel = null)
    {
    ...
    private StatusIconView(RectTransform root, IStatusIconViewModel? viewModel)
    {
        Root = root;
    ...
    public static StatusIconView Bind(RectTransform root, IStatusIconViewModel? viewModel = null) => new(root, viewModel);
