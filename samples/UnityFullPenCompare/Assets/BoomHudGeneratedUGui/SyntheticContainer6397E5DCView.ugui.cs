...
{
public sealed class SyntheticContainer6397E5DCView
{
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainer6397E5DCViewModel? _viewModel;
    public RectTransform Root { get; }
    public Text Char1FaceClassIcon { get; }

    public ISyntheticContainer6397E5DCViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainer6397E5DCView(Transform? parent = null, ISyntheticContainer6397E5DCViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer6397E5DCRoot", parent);
        ...
        ApplyStyle(Root, fg: "#000000", bg: "#000000", fontFamily: null, fontSize: null, borderColor: "#FFFFFF", borderWidth: 6f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        Char1FaceClassIcon = CreateText("Char1FaceClassIcon", Root);
        ...
        ApplyIconMetrics(Char1FaceClassIcon, boxWidth: 32f, boxHeight: 32f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 32f);
        ApplyTextMetrics(Char1FaceClassIcon, lineSpacing: null, wrapText: false);
    ...
    private SyntheticContainer6397E5DCView(RectTransform root, ISyntheticContainer6397E5DCViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Char1FaceClassIcon = RequireComponent<Text>(Root, "Char1FaceClassIcon");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer6397E5DCView Bind(RectTransform root, ISyntheticContainer6397E5DCViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            Char1FaceClassIcon.text = ResolveIconText(AsString(componentOverrideValue0));
        }
    }
