...
public sealed class SyntheticContainer33503E91View
{
    ...
    public TextMeshProUGUI TileWinsLabel { get; }
    public TextMeshProUGUI TileWinsValue { get; }
    ...
    public SyntheticContainer33503E91View(Transform? parent = null, ISyntheticContainer33503E91ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer33503E91Root", parent);
        ConfigureRect(Root, width: 122f, height: 160f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 122f, preferredHeight: 160f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 10f, 12, 12, 12, 12, "top-left");
        ApplyStyle(Root, fg: "#40C2F6", bg: "#40C2F6", fontFamily: null, fontSize: null, borderColor: "#16314A", borderWidth: 3f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        TileWinsLabel = CreateText("TileWinsLabel", Root);
        ConfigureRect(RectOf(TileWinsLabel), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(TileWinsLabel), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(TileWinsLabel), horizontal: false, vertical: false);
        ApplyStyle(TileWinsLabel, fg: "#12304B", bg: null, fontFamily: "Press Start 2P", fontSize: 8, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(TileWinsLabel, lineSpacing: null, wrapText: false);
        TileWinsLabel.text = "WINS";
        TileWinsLabel.gameObject.SetActive(true);
        TileWinsValue = CreateText("TileWinsValue", Root);
        ConfigureRect(RectOf(TileWinsValue), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(TileWinsValue), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(TileWinsValue), horizontal: false, vertical: false);
        ApplyStyle(TileWinsValue, fg: "#FFFFFF", bg: null, fontFamily: "Press Start 2P", fontSize: 20, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(TileWinsValue, lineSpacing: null, wrapText: false);
        TileWinsValue.text = "18";
        TileWinsValue.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer33503E91View(RectTransform root, ISyntheticContainer33503E91ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        TileWinsLabel = RequireComponent<TextMeshProUGUI>(Root, "TileWinsLabel");
        TileWinsValue = RequireComponent<TextMeshProUGUI>(Root, "TileWinsValue");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer33503E91View Bind(RectTransform root, ISyntheticContainer33503E91ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
