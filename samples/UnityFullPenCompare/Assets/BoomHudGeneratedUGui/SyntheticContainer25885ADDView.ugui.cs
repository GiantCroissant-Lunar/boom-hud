...
public sealed class SyntheticContainer25885ADDView
{
    ...
    public TextMeshProUGUI FilterHabText { get; }
    ...
    public SyntheticContainer25885ADDView(Transform? parent = null, ISyntheticContainer25885ADDViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer25885ADDRoot", parent);
        ConfigureRect(Root, width: 138f, height: 42f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 138f, preferredHeight: 42f, flexibleWidth: null, flexibleHeight: null);
        ...
        FilterHabText = CreateText("FilterHabText", Root);
        ConfigureRect(RectOf(FilterHabText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(FilterHabText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(FilterHabText), horizontal: false, vertical: false);
        ApplyStyle(FilterHabText, fg: "#C4C8D0", bg: null, fontFamily: "Press Start 2P", fontSize: 9, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(FilterHabText, lineSpacing: null, letterSpacing: null, wrapText: false);
        ApplyRectTransformMode(RectOf(FilterHabText), "center");
        ApplyContentSizeFit(RectOf(FilterHabText), horizontal: true, vertical: true);
        ApplyTextAlignment(FilterHabText, "center");
        FilterHabText.text = "HAB";
        FilterHabText.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer25885ADDView(RectTransform root, ISyntheticContainer25885ADDViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        FilterHabText = RequireComponent<TextMeshProUGUI>(Root, "FilterHabText");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer25885ADDView Bind(RectTransform root, ISyntheticContainer25885ADDViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
