...
public sealed class SyntheticContainer8FADC52CView
{
    ...
    public RectTransform NewBadgeOne { get; }
    public TextMeshProUGUI NewBadgeOneText { get; }
    public TextMeshProUGUI RowNewAdvancementText { get; }
    ...
    public SyntheticContainer8FADC52CView(Transform? parent = null, ISyntheticContainer8FADC52CViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer8FADC52CRoot", parent);
        ConfigureRect(Root, width: null, height: 66f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: null, preferredHeight: 66f, flexibleWidth: 1f, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyHorizontalLayout(Root, 14f, 12, 12, 12, 12, "top-left");
        ApplyStyle(Root, fg: "#F8D89A", bg: "#F8D89A", fontFamily: null, fontSize: null, borderColor: "#7D3E14", borderWidth: 4f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        NewBadgeOne = CreateRect("NewBadgeOne", Root);
        ConfigureRect(RectOf(NewBadgeOne), width: 94f, height: 40f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(NewBadgeOne), ignoreLayout: false, preferredWidth: 94f, preferredHeight: 40f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(NewBadgeOne), horizontal: false, vertical: false);
        ApplyVerticalLayout(RectOf(NewBadgeOne), 0f, 0, 0, 0, 0, "center");
        ApplyStyle(NewBadgeOne, fg: "#F8B325", bg: "#F8B325", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        NewBadgeOne.gameObject.SetActive(true);
        NewBadgeOneText = CreateText("NewBadgeOneText", RectOf(NewBadgeOne));
        ConfigureRect(RectOf(NewBadgeOneText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(NewBadgeOneText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(NewBadgeOneText), horizontal: false, vertical: false);
        ApplyStyle(NewBadgeOneText, fg: "#FFFFFF", bg: null, fontFamily: "Press Start 2P", fontSize: 9, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(NewBadgeOneText, lineSpacing: null, wrapText: false);
        NewBadgeOneText.text = "NEW!";
        NewBadgeOneText.gameObject.SetActive(true);
        RowNewAdvancementText = CreateText("RowNewAdvancementText", Root);
        ConfigureRect(RectOf(RowNewAdvancementText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(RowNewAdvancementText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(RowNewAdvancementText), horizontal: false, vertical: false);
        ApplyStyle(RowNewAdvancementText, fg: "#5A2A10", bg: null, fontFamily: "Press Start 2P", fontSize: 12, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(RowNewAdvancementText, lineSpacing: null, wrapText: false);
        RowNewAdvancementText.text = "ADVANCEMENT";
        RowNewAdvancementText.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer8FADC52CView(RectTransform root, ISyntheticContainer8FADC52CViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        NewBadgeOne = RequireRect(Root, "NewBadgeOne");
        NewBadgeOneText = RequireComponent<TextMeshProUGUI>(Root, "NewBadgeOne/NewBadgeOneText");
        RowNewAdvancementText = RequireComponent<TextMeshProUGUI>(Root, "RowNewAdvancementText");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer8FADC52CView Bind(RectTransform root, ISyntheticContainer8FADC52CViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
