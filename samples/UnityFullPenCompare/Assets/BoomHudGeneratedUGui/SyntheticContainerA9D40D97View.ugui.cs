...
public sealed class SyntheticContainerA9D40D97View
{
    ...
    public TextMeshProUGUI TabPlayText { get; }
    ...
    public SyntheticContainerA9D40D97View(Transform? parent = null, ISyntheticContainerA9D40D97ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerA9D40D97Root", parent);
        ConfigureRect(Root, width: 180f, height: 62f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 180f, preferredHeight: 62f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 0f, 0, 0, 0, 0, "center");
        ApplyStyle(Root, fg: "#FFFFFF", bg: "#FFFFFF", fontFamily: null, fontSize: null, borderColor: "#214B6F", borderWidth: 3f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        TabPlayText = CreateText("TabPlayText", Root);
        ConfigureRect(RectOf(TabPlayText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(TabPlayText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(TabPlayText), horizontal: false, vertical: false);
        ApplyStyle(TabPlayText, fg: "#1D3956", bg: null, fontFamily: "Press Start 2P", fontSize: 11, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(TabPlayText, lineSpacing: null, wrapText: false);
        TabPlayText.text = "PLAY";
        TabPlayText.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainerA9D40D97View(RectTransform root, ISyntheticContainerA9D40D97ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        TabPlayText = RequireComponent<TextMeshProUGUI>(Root, "TabPlayText");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerA9D40D97View Bind(RectTransform root, ISyntheticContainerA9D40D97ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
