...
{
public sealed class SyntheticContainerC701B3C7View
{
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainerC701B3C7ViewModel? _viewModel;
    ...
    public ISyntheticContainerC701B3C7ViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainerC701B3C7View(Transform? parent = null, ISyntheticContainerC701B3C7ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerC701B3C7Root", parent);
        ConfigureRect(Root, width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: 1f, flexibleHeight: 1f);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyHorizontalLayout(Root, 2f, 0, 0, 0, 0, "top-left");
        ApplyStyle(Root, fg: null, bg: null, fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        Node80 = CreateRect("Node80", Root);
    ...
    private SyntheticContainerC701B3C7View(RectTransform root, ISyntheticContainerC701B3C7ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Node80 = RequireRect(Root, "Node80");
        Node81 = RequireRect(Root, "Node81");
        Node82 = RequireRect(Root, "Node82");
        Node83 = RequireRect(Root, "Node83");
        Node84 = RequireRect(Root, "Node84");
        Node85 = RequireRect(Root, "Node85");
        Node86 = RequireRect(Root, "Node86");
        Node87 = RequireRect(Root, "Node87");
        Node88 = RequireRect(Root, "Node88");
        Node89 = RequireRect(Root, "Node89");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerC701B3C7View Bind(RectTransform root, ISyntheticContainerC701B3C7ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
