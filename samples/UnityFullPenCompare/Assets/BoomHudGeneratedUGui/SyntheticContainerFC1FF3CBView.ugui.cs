...
public sealed class SyntheticContainerFC1FF3CBView
{
    ...
    public TextMeshProUGUI Tag { get; }
    public TextMeshProUGUI Value { get; }
    public TextMeshProUGUI Time { get; }
    ...
    public SyntheticContainerFC1FF3CBView(Transform? parent = null, ISyntheticContainerFC1FF3CBViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerFC1FF3CBRoot", parent);
        ConfigureRect(Root, width: 164f, height: 132f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 164f, preferredHeight: 132f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 10f, 12, 12, 12, 12, "top-left");
        ApplyStyle(Root, fg: "#0C0C0C", bg: "#0C0C0C", fontFamily: null, fontSize: null, borderColor: "#7E7E7E", borderWidth: 4f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        Tag = CreateText("Tag", Root);
    ...
    private SyntheticContainerFC1FF3CBView(RectTransform root, ISyntheticContainerFC1FF3CBViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Tag = RequireComponent<TextMeshProUGUI>(Root, "Tag");
        Value = RequireComponent<TextMeshProUGUI>(Root, "Value");
        Time = RequireComponent<TextMeshProUGUI>(Root, "Time");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerFC1FF3CBView Bind(RectTransform root, ISyntheticContainerFC1FF3CBViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
