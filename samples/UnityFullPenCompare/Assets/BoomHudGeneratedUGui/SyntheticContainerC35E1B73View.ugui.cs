...
public sealed class SyntheticContainerC35E1B73View
{
    ...
    public RectTransform ModBox51 { get; }
    public TextMeshProUGUI ModLabel51 { get; }
    ...
    public SyntheticContainerC35E1B73View(Transform? parent = null, ISyntheticContainerC35E1B73ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerC35E1B73Root", parent);
        ConfigureRect(Root, width: 220f, height: 118f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 220f, preferredHeight: 118f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 10f, 12, 12, 12, 12, "top-left");
        ApplyStyle(Root, fg: "#181D25", bg: "#181D25", fontFamily: null, fontSize: null, borderColor: "#B61A22", borderWidth: 2f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        ModBox51 = CreateRect("ModBox51", Root);
        ConfigureRect(RectOf(ModBox51), width: 132f, height: 48f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(ModBox51), ignoreLayout: false, preferredWidth: 132f, preferredHeight: 48f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(ModBox51), horizontal: false, vertical: false);
        ApplyStyle(ModBox51, fg: "#525760", bg: "#525760", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        ModBox51.gameObject.SetActive(true);
        ModLabel51 = CreateText("ModLabel51", Root);
        ConfigureRect(RectOf(ModLabel51), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(ModLabel51), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(ModLabel51), horizontal: false, vertical: false);
        ApplyStyle(ModLabel51, fg: "#FFFFFF", bg: null, fontFamily: "Press Start 2P", fontSize: 10, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(ModLabel51, lineSpacing: null, wrapText: false);
        ModLabel51.text = "MOD A";
        ModLabel51.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainerC35E1B73View(RectTransform root, ISyntheticContainerC35E1B73ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        ModBox51 = RequireRect(Root, "ModBox51");
        ModLabel51 = RequireComponent<TextMeshProUGUI>(Root, "ModLabel51");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerC35E1B73View Bind(RectTransform root, ISyntheticContainerC35E1B73ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
