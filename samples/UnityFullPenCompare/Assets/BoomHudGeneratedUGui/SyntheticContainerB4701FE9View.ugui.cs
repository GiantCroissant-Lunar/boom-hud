...
public sealed class SyntheticContainerB4701FE9View
{
    ...
    public TextMeshProUGUI IconTabTwoText { get; }
    ...
    public SyntheticContainerB4701FE9View(Transform? parent = null, ISyntheticContainerB4701FE9ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerB4701FE9Root", parent);
        ConfigureRect(Root, width: 46f, height: 46f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 46f, preferredHeight: 46f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 0f, 0, 0, 0, 0, "center");
        ApplyStyle(Root, fg: "#2A1115", bg: "#2A1115", fontFamily: null, fontSize: null, borderColor: "#B61A22", borderWidth: 2f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        IconTabTwoText = CreateText("IconTabTwoText", Root);
        ConfigureRect(RectOf(IconTabTwoText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(IconTabTwoText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(IconTabTwoText), horizontal: false, vertical: false);
        ApplyStyle(IconTabTwoText, fg: "#FF6B57", bg: null, fontFamily: "Press Start 2P", fontSize: 11, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(IconTabTwoText, lineSpacing: null, wrapText: false);
        IconTabTwoText.text = "P";
        IconTabTwoText.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainerB4701FE9View(RectTransform root, ISyntheticContainerB4701FE9ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        IconTabTwoText = RequireComponent<TextMeshProUGUI>(Root, "IconTabTwoText");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerB4701FE9View Bind(RectTransform root, ISyntheticContainerB4701FE9ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
