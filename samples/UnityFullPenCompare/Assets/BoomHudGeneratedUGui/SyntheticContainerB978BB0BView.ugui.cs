...
public sealed class SyntheticContainerB978BB0BView
{
    ...
    public TextMeshProUGUI BuffIcon1 { get; }
    ...
    public SyntheticContainerB978BB0BView(Transform? parent = null, ISyntheticContainerB978BB0BViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerB978BB0BRoot", parent);
        ConfigureRect(Root, width: 56f, height: 56f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 56f, preferredHeight: 56f, flexibleWidth: null, flexibleHeight: null);
        ...
        ApplyStyle(Root, fg: "#000000", bg: "#000000", fontFamily: null, fontSize: null, borderColor: "#8C8C8C", borderWidth: 2f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        BuffIcon1 = CreateText("BuffIcon1", Root);
        ...
        ApplyIconMetrics(BuffIcon1, boxWidth: 24f, boxHeight: 24f, baselineOffset: 0f, opticalCentering: true, sizeMode: "fit-box", explicitFontSize: 24f);
    ...
    private SyntheticContainerB978BB0BView(RectTransform root, ISyntheticContainerB978BB0BViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        BuffIcon1 = RequireComponent<TextMeshProUGUI>(Root, "BuffIcon1");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerB978BB0BView Bind(RectTransform root, ISyntheticContainerB978BB0BViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            BuffIcon1.text = ResolveIconText(AsString(componentOverrideValue0));
        }
    }
