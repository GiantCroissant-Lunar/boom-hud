...
public sealed class SyntheticContainerA04D0699View
{
    ...
    public SyntheticContainerA04D0699View(Transform? parent = null, ISyntheticContainerA04D0699ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainerA04D0699Root", parent);
        ConfigureRect(Root, width: 44f, height: 44f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 44f, preferredHeight: 44f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 0f, 0, 0, 0, 0, "center");
        ApplyStyle(Root, fg: "#F1F1F1", bg: "#F1F1F1", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        SearchGlyph = CreateText("SearchGlyph", Root);
        ConfigureRect(RectOf(SearchGlyph), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(SearchGlyph), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(SearchGlyph), horizontal: false, vertical: false);
        ApplyStyle(SearchGlyph, fg: "#171717", bg: null, fontFamily: "Press Start 2P", fontSize: 10, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(SearchGlyph, lineSpacing: null, wrapText: false);
        SearchGlyph.text = "Q";
        SearchGlyph.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainerA04D0699View(RectTransform root, ISyntheticContainerA04D0699ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        SearchGlyph = RequireComponent<Text>(Root, "SearchGlyph");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainerA04D0699View Bind(RectTransform root, ISyntheticContainerA04D0699ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
