...
public sealed class SyntheticContainer7C99052FView
{
    ...
    public TextMeshProUGUI TabTwoText { get; }
    ...
    public SyntheticContainer7C99052FView(Transform? parent = null, ISyntheticContainer7C99052FViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer7C99052FRoot", parent);
        ...
        TabTwoText = CreateText("TabTwoText", Root);
        ConfigureRect(RectOf(TabTwoText), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(TabTwoText), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(TabTwoText), horizontal: false, vertical: false);
        ApplyStyle(TabTwoText, fg: "#F3E7C8", bg: null, fontFamily: "Press Start 2P", fontSize: 18, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(TabTwoText, lineSpacing: null, wrapText: false);
        TabTwoText.text = "[]";
        TabTwoText.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private SyntheticContainer7C99052FView(RectTransform root, ISyntheticContainer7C99052FViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        TabTwoText = RequireComponent<TextMeshProUGUI>(Root, "TabTwoText");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer7C99052FView Bind(RectTransform root, ISyntheticContainer7C99052FViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
