...
public sealed class MessageLogView
{
    ...
    public MessageLogView(Transform? parent = null, IMessageLogViewModel? viewModel = null)
    {
        ...
        ApplyVerticalLayout(Root, 8f, 8, 8, 8, 8);
    ...
    private MessageLogView(RectTransform root, IMessageLogViewModel? viewModel)
    {
        Root = root;
    ...
    public static MessageLogView Bind(RectTransform root, IMessageLogViewModel? viewModel = null) => new(root, viewModel);
