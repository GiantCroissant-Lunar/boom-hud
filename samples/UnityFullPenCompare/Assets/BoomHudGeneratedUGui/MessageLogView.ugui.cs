...
public sealed class MessageLogView
{
    ...
    public Text Line1 { get; }
    public Text Line2 { get; }
    public Text Line3 { get; }
    public Text Line4 { get; }
    public Text Line5 { get; }
    ...
    public MessageLogView(Transform? parent = null, IMessageLogViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("MessageLogRoot", parent);
        ConfigureRect(Root, width: 280f, height: 144f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 280f, preferredHeight: 144f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyVerticalLayout(Root, 8f, 8, 8, 8, 8, "bottom-left");
        ApplyStyle(Root, fg: "#000000", bg: "#000000", fontFamily: null, fontSize: null, borderColor: "#FFFFFF", borderWidth: 2f, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        Line1 = CreateText("Line1", Root);
        ConfigureRect(RectOf(Line1), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(Line1), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Line1), horizontal: false, vertical: false);
        ApplyStyle(Line1, fg: "#FFFFFF", bg: null, fontFamily: "Press Start 2P", fontSize: 16, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(Line1, lineSpacing: null, wrapText: false);
        Line1.text = "Activity log line.";
        Line1.gameObject.SetActive(true);
        Line2 = CreateText("Line2", Root);
        ConfigureRect(RectOf(Line2), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(Line2), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Line2), horizontal: false, vertical: false);
        ApplyStyle(Line2, fg: "#FFFFFF", bg: null, fontFamily: "Press Start 2P", fontSize: 16, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(Line2, lineSpacing: null, wrapText: false);
        Line2.text = "Second log entry.";
        Line2.gameObject.SetActive(true);
        Line3 = CreateText("Line3", Root);
        ConfigureRect(RectOf(Line3), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(Line3), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Line3), horizontal: false, vertical: false);
        ApplyStyle(Line3, fg: "#FFFFFF", bg: null, fontFamily: "Press Start 2P", fontSize: 16, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(Line3, lineSpacing: null, wrapText: false);
        Line3.text = "Third log entry.";
        Line3.gameObject.SetActive(true);
        Line4 = CreateText("Line4", Root);
        ConfigureRect(RectOf(Line4), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(Line4), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Line4), horizontal: false, vertical: false);
        ApplyStyle(Line4, fg: "#AAAAAA", bg: null, fontFamily: "Press Start 2P", fontSize: 16, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(Line4, lineSpacing: null, wrapText: false);
        Line4.text = "Fourth log entry.";
        Line4.gameObject.SetActive(true);
        Line5 = CreateText("Line5", Root);
        ConfigureRect(RectOf(Line5), width: null, height: null, left: null, top: null, absolute: false);
        ApplyLayoutSizing(RectOf(Line5), ignoreLayout: false, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Line5), horizontal: false, vertical: false);
        ApplyStyle(Line5, fg: "#AAAAAA", bg: null, fontFamily: "Press Start 2P", fontSize: 16, borderColor: null, borderWidth: null, treatAsIcon: false);
        ApplyTextMetrics(Line5, lineSpacing: null, wrapText: false);
    ...
    private MessageLogView(RectTransform root, IMessageLogViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Line1 = RequireComponent<Text>(Root, "Line1");
        Line2 = RequireComponent<Text>(Root, "Line2");
        Line3 = RequireComponent<Text>(Root, "Line3");
        Line4 = RequireComponent<Text>(Root, "Line4");
        Line5 = RequireComponent<Text>(Root, "Line5");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static MessageLogView Bind(RectTransform root, IMessageLogViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            Line1.text = AsString(componentOverrideValue0);
        }
        if (TryGetComponentOverrideValue("$/1", "Text", out var componentOverrideValue1))
        {
            Line2.text = AsString(componentOverrideValue1);
        }
        if (TryGetComponentOverrideValue("$/2", "Text", out var componentOverrideValue2))
        {
            Line3.text = AsString(componentOverrideValue2);
        }
        if (TryGetComponentOverrideValue("$/3", "Text", out var componentOverrideValue3))
        {
            Line4.text = AsString(componentOverrideValue3);
        }
        if (TryGetComponentOverrideValue("$/4", "Text", out var componentOverrideValue4))
        {
            Line5.text = AsString(componentOverrideValue4);
        }
    }
