...
public sealed class SyntheticContainer640002D6View
{
    ...
    public SyntheticContainer640002D6View(Transform? parent = null, ISyntheticContainer640002D6ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("SyntheticContainer640002D6Root", parent);
        ...
        ApplyTextMetrics(Char2StatsStat1, lineSpacing: null, wrapText: false);
        Char2StatsStat1.text = "ATK 6";
        Char2StatsStat1.gameObject.SetActive(true);
        Char2StatsStat2 = CreateText("Char2StatsStat2", Root);
        ...
        ApplyTextMetrics(Char2StatsStat2, lineSpacing: null, wrapText: false);
    ...
    private SyntheticContainer640002D6View(RectTransform root, ISyntheticContainer640002D6ViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Char2StatsStat1 = RequireComponent<Text>(Root, "Char2StatsStat1");
        Char2StatsStat2 = RequireComponent<Text>(Root, "Char2StatsStat2");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static SyntheticContainer640002D6View Bind(RectTransform root, ISyntheticContainer640002D6ViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            Char2StatsStat1.text = AsString(componentOverrideValue0);
        }
        if (TryGetComponentOverrideValue("$/1", "Text", out var componentOverrideValue1))
        {
            Char2StatsStat2.text = AsString(componentOverrideValue1);
        }
    }
