...
public sealed class StatBarView
{
    ...
    public StatBarView(Transform? parent = null, IStatBarViewModel? viewModel = null)
    {
    ...
    private StatBarView(RectTransform root, IStatBarViewModel? viewModel)
    {
        Root = root;
    ...
    public static StatBarView Bind(RectTransform root, IStatBarViewModel? viewModel = null) => new(root, viewModel);
