...
public sealed class StatBarView
{
    ...
    public StatBarView(Transform? parent = null, IStatBarViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        _componentOverrides = componentOverrides;
        Root = CreateRect("StatBarRoot", parent);
        ConfigureRect(Root, width: 108f, height: 12f, left: null, top: null, absolute: false);
        ApplyLayoutSizing(Root, ignoreLayout: false, preferredWidth: 108f, preferredHeight: 12f, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(Root, horizontal: false, vertical: false);
        ApplyStyle(Root, fg: "#333333", bg: "#333333", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Root.gameObject.SetActive(true);
        Fill = CreateRect("Fill", Root);
        ConfigureRect(RectOf(Fill), width: 80f, height: 12f, left: 0f, top: 0f, absolute: true);
        ApplyLayoutSizing(RectOf(Fill), ignoreLayout: true, preferredWidth: null, preferredHeight: null, flexibleWidth: null, flexibleHeight: null);
        ApplyContentSizeFit(RectOf(Fill), horizontal: false, vertical: false);
        ApplyStyle(Fill, fg: "#CCCCCC", bg: "#CCCCCC", fontFamily: null, fontSize: null, borderColor: null, borderWidth: null, treatAsIcon: false);
        Fill.gameObject.SetActive(true);
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    private StatBarView(RectTransform root, IStatBarViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        _componentOverrides = componentOverrides;
        Root = root;
        Fill = RequireRect(Root, "Fill");
        ApplyInstanceOverrides();
        ViewModel = viewModel;
    }

    public static StatBarView Bind(RectTransform root, IStatBarViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null) => new(root, viewModel, componentOverrides);
