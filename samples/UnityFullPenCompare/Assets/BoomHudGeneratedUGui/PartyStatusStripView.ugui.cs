...
public sealed class PartyStatusStripView
{
    ...
    public TextMeshProUGUI AreaName { get; }
    public TextMeshProUGUI EncounterState { get; }
    ...
    public TextMeshProUGUI MpText { get; }
    ...
    public TextMeshProUGUI HpText2 { get; }
    public RectTransform MpBar2 { get; }
    public RectTransform MpFill2 { get; }
    public TextMeshProUGUI MpText2 { get; }
    ...
    public TextMeshProUGUI HpText3 { get; }
    public RectTransform MpBar3 { get; }
    public RectTransform MpFill3 { get; }
    public TextMeshProUGUI MpText3 { get; }
    ...
    public PartyStatusStripView(Transform? parent = null, IPartyStatusStripViewModel? viewModel = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        ApplyVerticalLayout(Root, 16f, 24, 24, 24, 24, "top-left", childControlWidth: true, childControlHeight: false);
        ...
        ApplyHorizontalLayout(RectOf(Header), 0f, 0, 0, 0, 0, "top-left");
        ...
        ApplyHorizontalLayout(RectOf(MemberRow), 16f, 0, 0, 0, 0, "top-left", childControlWidth: false, childControlHeight: false);
        ...
        ApplyVerticalLayout(RectOf(MemberA), 12f, 12, 12, 12, 12, "top-left", childControlWidth: true, childControlHeight: false);
        ...
        ApplyHorizontalLayout(RectOf(StatusRow), 8f, 0, 0, 0, 0, "top-left");
        ...
        ApplyVerticalLayout(RectOf(MemberB), 12f, 12, 12, 12, 12, "top-left", childControlWidth: true, childControlHeight: false);
        ...
        ApplyHorizontalLayout(RectOf(StatusRow2), 8f, 0, 0, 0, 0, "top-left");
        ...
        ApplyVerticalLayout(RectOf(MemberC), 12f, 12, 12, 12, 12, "top-left", childControlWidth: true, childControlHeight: false);
        ...
        ApplyHorizontalLayout(RectOf(StatusRow3), 8f, 0, 0, 0, 0, "top-left");
    ...
    private PartyStatusStripView(RectTransform root, IPartyStatusStripViewModel? viewModel, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides)
    {
        ...
        AreaName = RequireComponent<TextMeshProUGUI>(Root, "Header/AreaName");
        EncounterState = RequireComponent<TextMeshProUGUI>(Root, "Header/EncounterState");
        ...
        HpText = RequireComponent<TextMeshProUGUI>(Root, "MemberRow/MemberA/HpBar/HpText");
        MpBar = RequireRect(Root, "MemberRow/MemberA/MpBar");
        MpFill = RequireRect(Root, "MemberRow/MemberA/MpBar/MpFill");
        MpText = RequireComponent<TextMeshProUGUI>(Root, "MemberRow/MemberA/MpBar/MpText");
        ...
        HpText2 = RequireComponent<TextMeshProUGUI>(Root, "MemberRow/MemberB/HpBar2/HpText2");
        MpBar2 = RequireRect(Root, "MemberRow/MemberB/MpBar2");
        MpFill2 = RequireRect(Root, "MemberRow/MemberB/MpBar2/MpFill2");
        MpText2 = RequireComponent<TextMeshProUGUI>(Root, "MemberRow/MemberB/MpBar2/MpText2");
        ...
        HpText3 = RequireComponent<TextMeshProUGUI>(Root, "MemberRow/MemberC/HpBar3/HpText3");
        MpBar3 = RequireRect(Root, "MemberRow/MemberC/MpBar3");
        MpFill3 = RequireRect(Root, "MemberRow/MemberC/MpBar3/MpFill3");
        MpText3 = RequireComponent<TextMeshProUGUI>(Root, "MemberRow/MemberC/MpBar3/MpText3");
