...
{
public sealed class SyntheticContainerA9D40D97View
{
    private readonly ISyntheticContainerA9D40D97ViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainerA9D40D97ViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label TabPlayText { get; }

    public ISyntheticContainerA9D40D97ViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainerA9D40D97View(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        TabPlayText = Root.Q<Label>("TabPlayText") ?? throw new InvalidOperationException("Could not find generated element 'TabPlayText'.");
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            TabPlayText.text = AsString(componentOverrideValue0);
            ApplyTextLabelStyle(TabPlayText, false);
        }
    }
    ...
    private void ApplyStaticValues()
    {
        ...
        Root.style.width = ParseStyleLength("180px");
        Root.style.height = ParseStyleLength("62px");
        ...
        Root.style.color = ParseStyleColor("#FFFFFF", null);
        Root.style.backgroundColor = ParseStyleColor("#FFFFFF", null);
        Root.style.borderLeftWidth = 3f;
        Root.style.borderRightWidth = 3f;
        Root.style.borderTopWidth = 3f;
        Root.style.borderBottomWidth = 3f;
        Root.style.borderLeftColor = ParseStyleColor("#214B6F", null);
        Root.style.borderRightColor = ParseStyleColor("#214B6F", null);
        Root.style.borderTopColor = ParseStyleColor("#214B6F", null);
        Root.style.borderBottomColor = ParseStyleColor("#214B6F", null);
        TabPlayText.style.marginTop = ParseStyleFloat("0px");
        TabPlayText.style.marginRight = ParseStyleFloat("0px");
        TabPlayText.style.marginBottom = ParseStyleFloat("0px");
        TabPlayText.style.marginLeft = ParseStyleFloat("0px");
        TabPlayText.style.flexDirection = ParseFlexDirection("column");
        TabPlayText.style.paddingTop = ParseStyleFloat("0px");
        TabPlayText.style.paddingRight = ParseStyleFloat("0px");
        TabPlayText.style.paddingBottom = ParseStyleFloat("0px");
        TabPlayText.style.paddingLeft = ParseStyleFloat("0px");
        TabPlayText.style.alignItems = ParseAlign("flex-start");
        TabPlayText.style.justifyContent = ParseJustify("flex-start");
        TabPlayText.text = "PLAY";
        ApplyTextLabelStyle(TabPlayText, false);
        TabPlayText.style.display = DisplayStyle.Flex;
        TabPlayText.SetEnabled(true);
        ApplyFontFamily(TabPlayText, "Press Start 2P", 11f);
        TabPlayText.style.color = ParseStyleColor("#1D3956", null);
        TabPlayText.style.fontSize = 11f;
        TabPlayText.style.unityFontStyleAndWeight = UnityEngine.FontStyle.Normal;
    }
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainerA9D40D97View";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainerA9D40D97View";
    private const string GeneratedRootName = "TabPlay";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainerA9D40D97View Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainerA9D40D97View(root, componentOverrides);
    }

    public static SyntheticContainerA9D40D97View Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
