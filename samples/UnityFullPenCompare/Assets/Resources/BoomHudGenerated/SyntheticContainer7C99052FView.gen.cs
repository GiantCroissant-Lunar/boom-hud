...
{
public sealed class SyntheticContainer7C99052FView
{
    private readonly ISyntheticContainer7C99052FViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainer7C99052FViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label TabTwoText { get; }

    public ISyntheticContainer7C99052FViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainer7C99052FView(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        TabTwoText = Root.Q<Label>("TabTwoText") ?? throw new InvalidOperationException("Could not find generated element 'TabTwoText'.");
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            TabTwoText.text = AsString(componentOverrideValue0);
            ApplyTextLabelStyle(TabTwoText, false);
        }
    }
    ...
    private void ApplyStaticValues()
    {
        ...
        TabTwoText.style.marginTop = ParseStyleFloat("0px");
        TabTwoText.style.marginRight = ParseStyleFloat("0px");
        TabTwoText.style.marginBottom = ParseStyleFloat("0px");
        TabTwoText.style.marginLeft = ParseStyleFloat("0px");
        TabTwoText.style.flexDirection = ParseFlexDirection("column");
        TabTwoText.style.paddingTop = ParseStyleFloat("0px");
        TabTwoText.style.paddingRight = ParseStyleFloat("0px");
        TabTwoText.style.paddingBottom = ParseStyleFloat("0px");
        TabTwoText.style.paddingLeft = ParseStyleFloat("0px");
        TabTwoText.style.alignItems = ParseAlign("flex-start");
        TabTwoText.style.justifyContent = ParseJustify("flex-start");
        TabTwoText.text = "[]";
        ApplyTextLabelStyle(TabTwoText, false);
        TabTwoText.style.display = DisplayStyle.Flex;
        TabTwoText.SetEnabled(true);
        ApplyFontFamily(TabTwoText, "Press Start 2P", 18f);
        TabTwoText.style.color = ParseStyleColor("#F3E7C8", null);
        TabTwoText.style.fontSize = 18f;
        TabTwoText.style.unityFontStyleAndWeight = UnityEngine.FontStyle.Normal;
    }
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainer7C99052FView";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainer7C99052FView";
    private const string GeneratedRootName = "TabTwo";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainer7C99052FView Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainer7C99052FView(root, componentOverrides);
    }

    public static SyntheticContainer7C99052FView Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
