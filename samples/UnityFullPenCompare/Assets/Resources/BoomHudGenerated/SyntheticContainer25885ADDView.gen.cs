...
{
public sealed class SyntheticContainer25885ADDView
{
    private readonly ISyntheticContainer25885ADDViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainer25885ADDViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label FilterHabText { get; }

    public ISyntheticContainer25885ADDViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainer25885ADDView(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        FilterHabText = Root.Q<Label>("FilterHabText") ?? throw new InvalidOperationException("Could not find generated element 'FilterHabText'.");
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            FilterHabText.text = AsString(componentOverrideValue0);
            ApplyTextLabelStyle(FilterHabText, false);
        }
    }
    ...
    private void ApplyStaticValues()
    {
        ...
        Root.style.width = ParseStyleLength("138px");
        Root.style.height = ParseStyleLength("42px");
        ...
        FilterHabText.style.marginTop = ParseStyleFloat("0px");
        FilterHabText.style.marginRight = ParseStyleFloat("0px");
        FilterHabText.style.marginBottom = ParseStyleFloat("0px");
        FilterHabText.style.marginLeft = ParseStyleFloat("0px");
        FilterHabText.style.flexDirection = ParseFlexDirection("column");
        FilterHabText.style.paddingTop = ParseStyleFloat("0px");
        FilterHabText.style.paddingRight = ParseStyleFloat("0px");
        FilterHabText.style.paddingBottom = ParseStyleFloat("0px");
        FilterHabText.style.paddingLeft = ParseStyleFloat("0px");
        FilterHabText.style.alignItems = ParseAlign("flex-start");
        FilterHabText.style.justifyContent = ParseJustify("flex-start");
        FilterHabText.text = "HAB";
        ApplyTextLabelStyle(FilterHabText, false);
        FilterHabText.style.display = DisplayStyle.Flex;
        FilterHabText.SetEnabled(true);
        ApplyFontFamily(FilterHabText, "Press Start 2P", 9f);
        FilterHabText.style.color = ParseStyleColor("#C4C8D0", null);
        FilterHabText.style.fontSize = 9f;
        FilterHabText.style.unityFontStyleAndWeight = UnityEngine.FontStyle.Normal;
    }
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainer25885ADDView";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainer25885ADDView";
    private const string GeneratedRootName = "FilterHab";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainer25885ADDView Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainer25885ADDView(root, componentOverrides);
    }

    public static SyntheticContainer25885ADDView Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
