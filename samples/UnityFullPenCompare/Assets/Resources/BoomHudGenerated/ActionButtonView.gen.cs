...
{
    private readonly IActionButtonViewModel? _initialViewModel = null;
    private IActionButtonViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label Icon { get; }

    public IActionButtonViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public ActionButtonView(VisualElement root)
    {
