...
{
public sealed class SyntheticContainerA04D0699View
{
    private readonly ISyntheticContainerA04D0699ViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainerA04D0699ViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label SearchGlyph { get; }

    public ISyntheticContainerA04D0699ViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainerA04D0699View(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        SearchGlyph = Root.Q<Label>("SearchGlyph") ?? throw new InvalidOperationException("Could not find generated element 'SearchGlyph'.");
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            SearchGlyph.text = AsString(componentOverrideValue0);
            ApplyTextLabelStyle(SearchGlyph, false);
        }
    }
    ...
    private void ApplyStaticValues()
    {
        ...
        Root.style.width = ParseStyleLength("44px");
        ...
        Root.style.color = ParseStyleColor("#F1F1F1", null);
        Root.style.backgroundColor = ParseStyleColor("#F1F1F1", null);
        SearchGlyph.style.marginTop = ParseStyleFloat("0px");
        SearchGlyph.style.marginRight = ParseStyleFloat("0px");
        SearchGlyph.style.marginBottom = ParseStyleFloat("0px");
        SearchGlyph.style.marginLeft = ParseStyleFloat("0px");
        SearchGlyph.style.flexDirection = ParseFlexDirection("column");
        SearchGlyph.style.paddingTop = ParseStyleFloat("0px");
        SearchGlyph.style.paddingRight = ParseStyleFloat("0px");
        SearchGlyph.style.paddingBottom = ParseStyleFloat("0px");
        SearchGlyph.style.paddingLeft = ParseStyleFloat("0px");
        SearchGlyph.style.alignItems = ParseAlign("flex-start");
        SearchGlyph.style.justifyContent = ParseJustify("flex-start");
        SearchGlyph.text = "Q";
        ApplyTextLabelStyle(SearchGlyph, false);
        SearchGlyph.style.display = DisplayStyle.Flex;
        SearchGlyph.SetEnabled(true);
        ApplyFontFamily(SearchGlyph, "Press Start 2P", 10f);
        SearchGlyph.style.color = ParseStyleColor("#171717", null);
        SearchGlyph.style.fontSize = 10f;
        SearchGlyph.style.unityFontStyleAndWeight = UnityEngine.FontStyle.Normal;
    }
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainerA04D0699View";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainerA04D0699View";
    private const string GeneratedRootName = "SearchTab";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainerA04D0699View Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainerA04D0699View(root, componentOverrides);
    }

    public static SyntheticContainerA04D0699View Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
