...
{
    private readonly ISyntheticContainer9463CA59ViewModel? _initialViewModel = null;
    ...
    public SyntheticContainer9463CA59View(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainer9463CA59View";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainer9463CA59View";
    private const string GeneratedRootName = "Row0";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainer9463CA59View Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainer9463CA59View(root, componentOverrides);
    }

    public static SyntheticContainer9463CA59View Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
