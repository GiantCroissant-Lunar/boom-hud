...
{
public sealed class SyntheticContainerB978BB0BView
{
    private readonly ISyntheticContainerB978BB0BViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainerB978BB0BViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label BuffIcon1 { get; }

    public ISyntheticContainerB978BB0BViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainerB978BB0BView(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            BuffIcon1.text = ResolveIconText(AsString(componentOverrideValue0), "lucide", 24f);
    ...
    private void ApplyStaticValues()
    {
        ...
        Root.style.borderLeftColor = ParseStyleColor("#8C8C8C", null);
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainerB978BB0BView";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainerB978BB0BView";
    private const string GeneratedRootName = "StatusBuff1";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainerB978BB0BView Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainerB978BB0BView(root, componentOverrides);
    }

    public static SyntheticContainerB978BB0BView Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
