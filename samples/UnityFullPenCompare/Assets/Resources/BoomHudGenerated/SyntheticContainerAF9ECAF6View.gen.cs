...
{
    private readonly ISyntheticContainerAF9ECAF6ViewModel? _initialViewModel = null;
    ...
    public SyntheticContainerAF9ECAF6View(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            RoleIcon.text = ResolveIconText(AsString(componentOverrideValue0), "lucide", 40f);
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainerAF9ECAF6View";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainerAF9ECAF6View";
    private const string GeneratedRootName = "HeroRow";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainerAF9ECAF6View Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainerAF9ECAF6View(root, componentOverrides);
    }

    public static SyntheticContainerAF9ECAF6View Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
