...
{
    private readonly IStatusIconViewModel? _initialViewModel = null;
    private IStatusIconViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label Icon { get; }

    public IStatusIconViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public StatusIconView(VisualElement root)
    {
        Root = root as VisualElement ?? throw new ArgumentException("Expected root element type VisualElement.", nameof(root));
        Icon = Root.Q<Label>("Icon") ?? throw new InvalidOperationException("Could not find generated element 'Icon'.");
    ...
    private void ApplyStaticValues()
    {
        ...
        Icon.text = ResolveIconText("flame", "lucide", 24f);
        ApplyIconLabelStyle(Icon, 24f, 24f);
