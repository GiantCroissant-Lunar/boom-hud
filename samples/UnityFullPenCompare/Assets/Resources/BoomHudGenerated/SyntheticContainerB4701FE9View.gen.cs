...
{
public sealed class SyntheticContainerB4701FE9View
{
    private readonly ISyntheticContainerB4701FE9ViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainerB4701FE9ViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label IconTabTwoText { get; }

    public ISyntheticContainerB4701FE9ViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainerB4701FE9View(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        IconTabTwoText = Root.Q<Label>("IconTabTwoText") ?? throw new InvalidOperationException("Could not find generated element 'IconTabTwoText'.");
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            IconTabTwoText.text = AsString(componentOverrideValue0);
            ApplyTextLabelStyle(IconTabTwoText, false);
        }
    }
    ...
    private void ApplyStaticValues()
    {
        ...
        Root.style.width = ParseStyleLength("46px");
        Root.style.height = ParseStyleLength("46px");
        ...
        Root.style.color = ParseStyleColor("#2A1115", null);
        Root.style.backgroundColor = ParseStyleColor("#2A1115", null);
        ...
        IconTabTwoText.style.marginTop = ParseStyleFloat("0px");
        IconTabTwoText.style.marginRight = ParseStyleFloat("0px");
        IconTabTwoText.style.marginBottom = ParseStyleFloat("0px");
        IconTabTwoText.style.marginLeft = ParseStyleFloat("0px");
        IconTabTwoText.style.flexDirection = ParseFlexDirection("column");
        IconTabTwoText.style.paddingTop = ParseStyleFloat("0px");
        IconTabTwoText.style.paddingRight = ParseStyleFloat("0px");
        IconTabTwoText.style.paddingBottom = ParseStyleFloat("0px");
        IconTabTwoText.style.paddingLeft = ParseStyleFloat("0px");
        IconTabTwoText.style.alignItems = ParseAlign("flex-start");
        IconTabTwoText.style.justifyContent = ParseJustify("flex-start");
        IconTabTwoText.text = "P";
        ApplyTextLabelStyle(IconTabTwoText, false);
        IconTabTwoText.style.display = DisplayStyle.Flex;
        IconTabTwoText.SetEnabled(true);
        ApplyFontFamily(IconTabTwoText, "Press Start 2P", 10f);
        IconTabTwoText.style.color = ParseStyleColor("#FF6B57", null);
        IconTabTwoText.style.fontSize = 10f;
        IconTabTwoText.style.unityFontStyleAndWeight = UnityEngine.FontStyle.Normal;
    }
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainerB4701FE9View";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainerB4701FE9View";
    private const string GeneratedRootName = "IconTabTwo";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainerB4701FE9View Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainerB4701FE9View(root, componentOverrides);
    }

    public static SyntheticContainerB4701FE9View Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
