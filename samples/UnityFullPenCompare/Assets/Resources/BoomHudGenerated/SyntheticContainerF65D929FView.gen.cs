...
{
public sealed class SyntheticContainerF65D929FView
{
    private readonly ISyntheticContainerF65D929FViewModel? _initialViewModel = null;
    private readonly IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? _componentOverrides;
    private ISyntheticContainerF65D929FViewModel? _viewModel;

    public VisualElement Root { get; }
    public Label TabThreeText { get; }

    public ISyntheticContainerF65D929FViewModel? ViewModel
    {
        get => _viewModel;
        set
        {
    ...
    public SyntheticContainerF65D929FView(VisualElement root, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        ...
        TabThreeText = Root.Q<Label>("TabThreeText") ?? throw new InvalidOperationException("Could not find generated element 'TabThreeText'.");
    ...
    private void ApplyInstanceOverrides()
    {
        ...
        {
            TabThreeText.text = AsString(componentOverrideValue0);
            ApplyTextLabelStyle(TabThreeText, false);
        }
    }
    ...
    private void ApplyStaticValues()
    {
        ...
        Root.style.width = ParseStyleLength("86px");
        Root.style.height = ParseStyleLength("86px");
        ...
        Root.style.color = ParseStyleColor("#334355", null);
        Root.style.backgroundColor = ParseStyleColor("#334355", null);
        TabThreeText.style.marginTop = ParseStyleFloat("0px");
        TabThreeText.style.marginRight = ParseStyleFloat("0px");
        TabThreeText.style.marginBottom = ParseStyleFloat("0px");
        TabThreeText.style.marginLeft = ParseStyleFloat("0px");
        TabThreeText.style.flexDirection = ParseFlexDirection("column");
        TabThreeText.style.paddingTop = ParseStyleFloat("0px");
        TabThreeText.style.paddingRight = ParseStyleFloat("0px");
        TabThreeText.style.paddingBottom = ParseStyleFloat("0px");
        TabThreeText.style.paddingLeft = ParseStyleFloat("0px");
        TabThreeText.style.alignItems = ParseAlign("flex-start");
        TabThreeText.style.justifyContent = ParseJustify("flex-start");
        TabThreeText.text = "!";
        ApplyTextLabelStyle(TabThreeText, false);
        TabThreeText.style.display = DisplayStyle.Flex;
        TabThreeText.SetEnabled(true);
        ApplyFontFamily(TabThreeText, "Press Start 2P", 22f);
        TabThreeText.style.color = ParseStyleColor("#F3E7C8", null);
        TabThreeText.style.fontSize = 22f;
        TabThreeText.style.unityFontStyleAndWeight = UnityEngine.FontStyle.Normal;
    }
    ...
    private const string VisualTreeResourcePath = "BoomHudGenerated/SyntheticContainerF65D929FView";
    private const string StyleSheetResourcePath = "BoomHudGenerated/SyntheticContainerF65D929FView";
    private const string GeneratedRootName = "TabThree";
    private static VisualTreeAsset? s_visualTreeAsset;
    private static StyleSheet? s_generatedStyleSheet;

    public static SyntheticContainerF65D929FView Create(VisualElement parent, string? instanceName = null, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (parent == null)
        {
        ...
        parent.Add(root);
        return new SyntheticContainerF65D929FView(root, componentOverrides);
    }

    public static SyntheticContainerF65D929FView Attach(VisualElement placeholder, IReadOnlyDictionary<string, IReadOnlyDictionary<string, object?>>? componentOverrides = null)
    {
        if (placeholder == null)
        {
